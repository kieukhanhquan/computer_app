...
const DeleteComment = (comment) => {
    return (
        <div className="modal fade" id="delete" tabIndex="-1" role="dialog" aria-hidden="true">
            <div className="modal-dialog modal-dialog-centered" role="document">
                <div className="modal-content" style={{ width: "400px", height: "350px" }}>
                    <div className="modal-body d-flex flex-column justify-content-around align-items-center">
                        <h4 className="text-center">Xác nhận xóa bình luận từ người dùng {comment.username}</h4>
