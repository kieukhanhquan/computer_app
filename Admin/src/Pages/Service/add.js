                        ...
                        <div className="modal-body">
                            <div className="row">
                                <div className="form-group col">
                                    ...
                                    <input type="text" className="form-control" id="v_name" maxLength="50" required />
                                    <div className="invalid-feedback">Vui lòng nhập tên voucher!</div>
                                </div>
                                <div className="form-group col">
                                    <label htmlFor="v_value" className="col-form-label">Giá trị</label>
                                    <input type="text" className="form-control" id="v_value" maxLength="50" required />
                            ...
                            <div className="row">
                                <div className="form-group col">
                                    ...
                                    <input type="text" className="form-control" id="v_rqm" maxLength="10" required />
                                ...
                                <div className="form-group col">
                                    ...
                                    <input type="text" className="form-control" id="v_tag" maxLength="10" required />
